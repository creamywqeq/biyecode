import {
  CellType,
  vtkCellTypes$1
} from "./chunk-3K2Z67AS.js";
import {
  vtkPoints$1
} from "./chunk-CULGR6JL.js";
import {
  vtkCellArray$1
} from "./chunk-SJFCNXI3.js";
import {
  vtkPlane$1
} from "./chunk-OJWUGU3K.js";
import {
  vtkDataArray$1
} from "./chunk-QODQMHT2.js";
import {
  add,
  cross,
  determinant2x2,
  ...
  subtract,
  vtkMath
} from "./chunk-H4XGZ32F.js";
import {
  TYPED_ARRAYS,
  macro,
  vtk
} from "./chunk-5XJWGF7S.js";
import {
  __export
...
function scale4(bounds, sx, sy, sz) {
  if (!isValid(bounds)) {
    return false;
  }
  if (sx >= 0) {
...
var BoundingBox = class {
  ...
  equals(otherBounds) {
    return equals4(this.bounds, otherBounds);
  }
  isValid() {
  ...
  scale(sx, sy, sz) {
    return scale4(this.bounds, sx, sy, sz);
  }
  getCenter() {
...
var newInstance2 = macro.newInstance(extend, "vtkCell");
var vtkCell$1 = {
...
var newInstance3 = macro.newInstance(extend2, "vtkCellLinks");
var vtkCellLinks$1 = {
...
var newInstance4 = macro.newInstance(extend3, "vtkLine");
var vtkLine$1 = {
...
var newInstance5 = macro.newInstance(extend4, "vtkFieldData");
var vtkFieldData$1 = {
...
var newInstance6 = macro.newInstance(extend5, "vtkDataSetAttributes");
...
var newInstance7 = macro.newInstance(extend6, "vtkDataSet");
var vtkDataSet$1 = {
...
var newInstance8 = macro.newInstance(extend7, "vtkPointSet");
var vtkPointSet$1 = {
...
function vtkPolyLine(publicAPI, model) {
  ...
  publicAPI.findPointIdAtDistanceFromFirstPoint = (distance2) => {
    ...
    if (distance2 < distances[minId] || distance2 > distances[maxId] || distances[maxId] === 0) {
      return -1;
    }
    while (maxId - minId > 1) {
      const midId = Math.floor((minId + maxId) / 2);
      if (distances[midId] <= distance2) {
        minId = midId;
      } else {
        maxId = midId;
      }
...
var newInstance9 = macro.newInstance(extend8, "vtkPolyLine");
var vtkPolyLine$1 = {
...
var newInstance10 = macro.newInstance(extend9, "vtkPriorityQueue");
...
var newInstance11 = macro.newInstance(extend10, "vtkPolygon");
var vtkPolygon$1 = {
...
var newInstance12 = macro.newInstance(extend11, "vtkTriangle");
var vtkTriangle$1 = {
...
var newInstance13 = macro.newInstance(extend12, "vtkQuad");
var vtkQuad$1 = {
...
var newInstance14 = macro.newInstance(extend13, "vtkTriangleStrip");
...
function vtkPolyData(publicAPI, model) {
  ...
  function camelize(str3) {
    return str3.replace(/(?:^\w|[A-Z]|\b\w)/g, (letter) => letter.toUpperCase()).replace(/\s+/g, "");
  }
  function clearCells() {
    model.cells = void 0;
    model.links = void 0;
  ...
  publicAPI.buildCells = () => {
    ...
    if (nLines) {
      ...
      model.lines.getCellSizes().forEach((numCellPts, index) => {
        ...
        if (numCellPts === 1) {
          vtkWarningMacro3("Building VTK_LINE ", index, " with only one point, but VTK_LINE needs at least two points. Check the input.");
        }
        nextCellPts += numCellPts + 1;
      });
    ...
    if (nPolys) {
      ...
      model.polys.getCellSizes().forEach((numCellPts, index) => {
        ...
        if (numCellPts < 3) {
          vtkWarningMacro3("Building VTK_TRIANGLE ", index, " with less than three points, but VTK_TRIANGLE needs at least three points. Check the input.");
        }
        nextCellPts += numCellPts + 1;
      });
  ...
  publicAPI.getMaxCellSize = () => POLYDATA_FIELDS.reduce((max2, type) => Math.max(max2, model[type]?.getMaxCellSize?.() ?? 0), 0);
}
...
function extend14(publicAPI, model, initialValues = {}) {
...
var newInstance15 = macro.newInstance(extend14, "vtkPolyData");
var vtkPolyData$1 = {
...
export {
  CELL_FACTORY,
  extend14 as extend,
  newInstance15 as newInstance,
  vtkPolyData$1
};
//# sourceMappingURL=chunk-RPPB2RQC.js.map
